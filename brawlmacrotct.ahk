...
global VERSION_ACTUAL := "31.5.13"

; ===== TEMAS =====
temas := [
    ; ─────────── CLAROS (ordenados por color, espectro) ───────────
    ...
    ; ─────────── OSCUROS (ordenados por color, espectro) ───────────
    ...
    ; ─────────── SECRETOS (ordenados por color, espectro) ───────────
...
cooldownText.SetFont("s8", "Segoe UI")   ; fuente compacta para el visor de detección en vivo
